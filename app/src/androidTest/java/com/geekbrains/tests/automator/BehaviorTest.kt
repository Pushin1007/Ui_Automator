...
class BehaviorTest {
    ...
    fun test_SearchIsPositive() {
        ...
        Assert.assertEquals(changedText.text.toString(), "Number of results: 708")
    }
    ...
    fun test_Search_OpenDetails() {
        ...
        Assert.assertEquals(changedText.text, "Number of results: 708")
    }
    ...
    fun test_Search_OpenDetails_ButtonClick() {
        ...
        Assert.assertEquals(changedText.text, "Number of results: 710")
    }
